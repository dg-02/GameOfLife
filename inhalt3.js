...
var Grid = function(width, height){                                     //Raster
    ...
    me.updateLiving = function(){
        ...
        var totUeber = _cells.filter(function(cell){
            return cell.isAlive && (cell.countNeighbors() > 5 || cell.countNeighbors() === 3);
        });                                                               //Tod durch Ueberbevoelkerung
        ...
        var lebtWeiter = _cells.filter(function(cell){
            return cell.isAlive && (cell.countNeighbors() === 2 || cell.countNeighbors() === 4  ||
                cell.countNeighbors() === 5);
        });                                                               //Ueberleben
...
/*Lebende Zellen mit drei oder mehr als fünf lebenden Nachbarn sterben in der Folgegeneration an Überbevölkerung.
  Lebende Zellen mit weniger als zwei lebenden Nachbarn sterben in der Folgegeneration an Einsamkeit.
  Eine lebende Zelle mit zwei, vier oder fünf lebenden Nachbarn bleibt in der Folgegeneration am Leben.
